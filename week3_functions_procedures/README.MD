...
No changes were made to the underlying table structure from the starter code.
...
The three core tables (`vessels`, `passengers`, `trips`) remain unchanged from the starter code. Key fields:
